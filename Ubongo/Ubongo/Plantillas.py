...
class template(object):
    ...
    pnt = [pygame.image.load('plantilla1.png'), pygame.image.load('plantilla2.png'), pygame.image.load('plantilla3.png'), pygame.image.load('plantilla4.png'), pygame.image.load('plantilla5.png'), pygame.image.load('plantilla6.png'), pygame.image.load('plantilla7.png'), pygame.image.load('plantilla9.png'), pygame.image.load('plantilla10.png'), pygame.image.load('plantilla11.png') ]
